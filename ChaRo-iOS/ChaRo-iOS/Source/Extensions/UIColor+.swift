...
extension UIColor {
    ...
    @nonobjc class var mainLightBlue: UIColor {
        return UIColor(red: 157.0 / 255.0, green: 194.0 / 255.0, blue: 253.0 / 255.0, alpha: 1.0)
    }
    ...
    @nonobjc class var mainSkyBlue: UIColor {
        return UIColor(red: 108.0 / 255.0, green: 166.0 / 255.0, blue: 255.0 / 255.0, alpha: 1.0)
    }
    ...
    @nonobjc class var subBlack: UIColor {
        return UIColor(red: 33.0 / 255.0, green: 36.0 / 255.0, blue: 41.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var blueSelect: UIColor {
        return UIColor(red: 243.0 / 255.0, green: 248.0 / 255.0, blue: 255.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var neomorfismBlueLine: UIColor {
        return UIColor(red: 157.0 / 255.0, green: 195.0 / 255.0, blue: 253.0 / 255.0, alpha: 1.0)
    }
    
    @nonobjc class var semiBlack: UIColor {
        return UIColor(red: 37.0 / 255.0, green: 34.0 / 255.0, blue: 34.0 / 255.0, alpha: 1.0)
    }
